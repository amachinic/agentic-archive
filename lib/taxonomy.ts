...
export const ALIASES: Record<string, string> = {
  ...
  /* the work words a model reaches for that the list does not spell. Each
     was blanked by the old facet gate and left the brief empty while an
     earlier keyterm stood -- measured on the catalogue: drawing, engraving,
     mixed-media, zine. They fold to the nearest listed work. */
  ...
  "magazine spread": "magazine page",
  "flyer": "poster",
  "poster design": "poster",
  "book page": "book spread",
  "album art": "record sleeve",
  "cd cover": "record sleeve",
  "record cover": "record sleeve",
  "screen capture": "screenshot",
  "screen grab": "screenshot",
  "render": "3d render",
  "3d": "3d render",
  "installation view": "artwork reproduction",
  "exhibition view": "artwork reproduction",
